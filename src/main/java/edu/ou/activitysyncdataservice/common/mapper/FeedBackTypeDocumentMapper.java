...
@Mapper
public interface FeedBackTypeDocumentMapper {
    FeedBackTypeDocumentMapper INSTANCE = Mappers.getMapper(FeedBackTypeDocumentMapper.class);

    /**
     * Map HashMap<String, String> object to FeedBackTypeDocument object
     *
     * @param map represents for FeedBackTypeAddRequest object
     * @return FeedBackTypeDocument object
    ...
    FeedBackTypeDocument fromMap(Map<String, Object> map);
