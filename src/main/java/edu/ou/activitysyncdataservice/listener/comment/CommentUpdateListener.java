...
public class CommentUpdateListener implements IBaseListener<Object, Object> {
    private final IBaseRepository<CommentDocument, CommentDocument> commentUpdateRepository;
    private final MessageConverter messageConverter;

    /**
     * Update information exist comment
     *
     * @param comment comment
     * @author Nguyen Trung Kien - OU
     */
    @Override
    @RabbitListener(queues = {CommentUpdateQueueI.QUEUE})
    public Object execute(Object comment) {
        ...
        return commentUpdateRepository.execute(commentDocument);
    }
}
